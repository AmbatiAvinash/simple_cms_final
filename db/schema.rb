...
ActiveRecord::Schema.define(version: 20190306172538) do
  ...
  create_table "pages_users", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "page_id"
    t.integer "user_id"
    t.index ["page_id", "user_id"], name: "index_pages_users_on_page_id_and_user_id", using: :btree
  end
  ...
  create_table "section_edits", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id"], name: "index_section_edits_on_user_id", using: :btree
  end
